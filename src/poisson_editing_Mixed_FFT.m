function figure2 = poisson_editing_Mixed_FFT(source,destination,mask,filename,rangexl,rangexr,rangeyl,rangeyu,locationx,locationy)
...
figure2(:,:,1) = uint8(FFT_Mixed(V1,double(figure2(:,:,1)),M,locationx,locationy));
figure2(:,:,2) = uint8(FFT_Mixed(V2,double(figure2(:,:,2)),M,locationx,locationy));
figure2(:,:,3) = uint8(FFT_Mixed(V3,double(figure2(:,:,3)),M,locationx,locationy));
