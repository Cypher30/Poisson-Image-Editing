function poisson_editing_FDM(source,destination,mask,filename,rangexl,rangexr,rangeyl,rangeyu,locationx,locationy)
...
figure2(locationy + 1:locationy + rangeyu - rangeyl - 1,locationx + 1:locationx + rangexr - rangexl - 1,1) = uint8(FDM(V1,F1,M,BXL1,BXR1,BYL1,BYU1));
figure2(locationy + 1:locationy + rangeyu - rangeyl - 1,locationx + 1:locationx + rangexr - rangexl - 1,2) = uint8(FDM(V2,F2,M,BXL2,BXR2,BYL2,BYU2));
figure2(locationy + 1:locationy + rangeyu - rangeyl - 1,locationx + 1:locationx + rangexr - rangexl - 1,3) = uint8(FDM(V3,F3,M,BXL3,BXR3,BYL3,BYU3));
